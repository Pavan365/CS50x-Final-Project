...
def get_info(ticker):
    ...
    url = f"https://www.alphavantage.co/query?function=OVERVIEW&symbol={ticker}&apikey=BQAR502ANNGJZ1DI"
...
def get_time_series(ticker):
    ...
    url = f"https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol={ticker}&apikey=BQAR502ANNGJZ1DI"
    response = requests.get(url)
